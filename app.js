...
function setWorkoutMode(mode){if(!WORKOUT_MODES[mode])return;localStorage.setItem(workoutModeKey(),mode);localStorage.removeItem(missionProgressKey());renderSystemMission()}
